    ...
    <div class="picture is-flex justy-between">
      <div class="is-flex">
        ...
        <input
          ...
          hidden
        />
        <a @click="uploadFile" class="my-add-btn ml-4 has-text-weight-semibold">
          <span class="icons box add-btn mr-2">
            <i class="fas fa-plus"></i>
          </span>
          <span class="is-size-7">Add a photo</span>
          <span v-if="notImage" class="is-block is-red is-size-7"
...
export default Vue.extend({
  data() {
    return {
      ...
      file: '',
      image:
        'https://crosscut.com/sites/default/files/styles/max_2000x2000/public/images/articles/veronica_001.jpg',
    ...
    changeImage() {
      ...
      if (this.file) {
        if (/\.(jpe?g|png|gif)$/i.test(this.file.name)) {
          if (this.file.size < 5000000) reader.readAsDataURL(this.file)
